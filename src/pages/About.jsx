	...
	return (
		<div className="container">
			...
			<div className="text-center">
				...
				technical background to develop creative and engaging web content.
				<br />
				<br />
				I have earned a certificate in full-stack web development from the
				University of Toronto with knowledge of the MERN stack of technologies.
				I have a solid understanding of various frameworks and technologies that
				support the MERN stack, as well as various programming methods such as
				building Progressive Web Applications, Object-Oriented Programming,
				Model-View-Controller, and Object-Relational Mapping.
				<br />
